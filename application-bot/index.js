...
client.on('message', async message => {
    ...
    let questions = {
        firstQuestion: "Whats your username? ``Example: !  ReqaznTheDev™#4972``",
        secondQuestion: "What department are you applying for?",
        ...
        sixthQuestion: "Anything else you'd like to add?",
    }
                                    ...
                                    msg.channel.awaitMessages(filter1, {
                                        ...
                                        message.author.send(questions.fifthQuestion).then(msg => {
                                            ...
                                            msg.channel.awaitMessages(filter1, {
                                                ...
                                                message.author.send("Submitted application! ``made by ReqaznTheDev.``").then(msg => {
